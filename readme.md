...
- [Node hexagonal boilerplate](https://github.com/claytonsilva/nodejs-hexagonal-boilerplate) - Boilerplate using Hexagonal architecture with Full tested TODO implementation on AWS DynamoDB.
